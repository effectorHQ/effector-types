...
### Added
- `types.json` — Machine-readable catalog of **40 standard Effector types** (15 input, 14 output, 11 context; with roles, fields, aliases, subtype relations, ClawHub frequency data)
